...
void loop()   /*----( LOOP: RUNS CONSTANTLY )----*/
{
  ...
  if( (oldXValue > (sensorXValue + 25)) || (oldXValue < (sensorXValue - 25)) || (oldYValue > (sensorYValue + 25)) || (oldYValue < (sensorYValue - 25)) || (oldButtonState != buttonState || oldYValue < 30 || oldYValue > 990 || oldXValue <30 || oldXValue > 990)){
...
*/
  ...
  lcd.setCursor(0,1);
  lcd.print("L sensor: ");
 // lcd.print(); // NEED TO ADD VARIABLE FOR LIGHT SENSOR!!!!!!!!!!!!!!!!!!!!
